generateBEASTGeoXML_HHS <- function(clusterdata,season,subtype){
...
<logTree id="tree1.treeFileLog2" logEvery="10000" nexusFormat="true" fileName="tree1.hhs.geo.history.trees" sortTranslationTable="true">
			<treeModel idref="tree1.treeModel"/>	
			<markovJumpsTreeLikelihood idref="tree1.state.treeLikelihood"/>
		</logTree>
							'
  ...
  generateXML <- function(clusterdata,season,subtype){
    ...
    cat(str,file=paste0("beast_xmls/",season,"_",subtype,'/',season,"_",subtype,'_geo_hhs.xml'))
  }
